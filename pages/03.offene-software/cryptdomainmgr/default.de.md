...
Für unsere E-Mail-Domain ``imap1234.entroserv.de`` nutzen wir ein Zertifikat ohne OCSP, weil _Thunderbird_ kein OCSP unterstützt. Diese Zertifikat ist unter ``/etc/cryptdomainmgr/imap1234.entroserv.de/fullchain.pem`` zu finden.
