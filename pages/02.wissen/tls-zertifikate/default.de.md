...
metadata:
    description: 'Ein TLS-Zertifikat ist ein Identitätsnachweis eines Kommunikationpartners, ein elektronischer Ausweis, der von einer Zertifizierungsstelle ausgestellt wird.'
visible: true
---
