...
metadata:
    description: 'TLS-Zertifikate sind Identitätsnachweise von Kommunikationpartnern, eine Art elektronischer Personalausweis, der von einer Zertifizierungsstelle ausgestellt wird.'
visible: true
---
